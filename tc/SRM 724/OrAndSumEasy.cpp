...
class OrAndSumEasy {
    public:
    string isPossible(long long Or, long long Sum) {
		long long And=Sum-Or;
		if((And&Or)==And&&(And|Or)==Or)return "Possible";
